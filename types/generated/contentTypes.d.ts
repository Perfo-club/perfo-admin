...
export interface ApiCamCam extends Schema.CollectionType {
  collectionName: 'cams';
  info: {
    singularName: 'cam';
    pluralName: 'cams';
...
export interface ApiEnclosureEnclosure extends Schema.CollectionType {
...
export interface ApiMatchResultMatchResult extends Schema.CollectionType {
